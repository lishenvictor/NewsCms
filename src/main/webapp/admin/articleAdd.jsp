...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/admin/article/save.do",{'title':title,'contentNoTag':contentNoTag,'content':content,'summary':summary,'crawlerDate':crawlerDate,'arcType.id':typeId,'tags':tags,'orUrl':orUrl,'state':state},function(result){
				if(result.success){
...
<body style="margin: 10px">
	<div id="p" class="easyui-panel" title="编写新闻" style="padding: 10px">
